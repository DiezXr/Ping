...
Don't forget to join my [Channel](http://t.me/LogsXr) to recieve information on all the latest updates.
...
If you have any questions on how to use me, ask in my Account [Dev](https://t.me/DiezXr). More on my [Channels ](https://t.me/LogsXr).
'''
  await teletips.send_message(message.chat.id, text, disable_web_page_preview=True)
